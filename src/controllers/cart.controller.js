...
class CartController {
    ...
    async purchaseCart(req, res) {
        try {
          ...
          /* FILTRA PRODUCTOS QUE NO PUDIERON SER COMPRADOS */
          ...
          /* ACTUALIZA CARRITO SOLO CON LOS PRODUCTOS QUE NO PUDIERON SER COMPRADOS */
          cart.products = productsNotPurchased;
          await cart.save();
      
          /* CREA UN TICKET D COMPRA UTILIZANDO SERVICIO D TICKETS */
